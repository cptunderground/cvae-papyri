#!/bin/bash 
#SBATCH --job-name=cvae-10000-gpu    #Name of your job
...
#SBATCH --output=cvae-cluster-10000.o   #Path and name to the file for the STDOUT
#SBATCH --error=cvae-cluster-10000.e    #Path and name to the file for the STDERR
...
python main.py --config="./_config/config-cluster_10000_gpu.json"
